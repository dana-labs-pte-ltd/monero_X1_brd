...
set rc [catch {
  ...
  add_files -quiet /media/wanner/work/work/fpga_prj/Xmrig-fpga/xmrig_X1_brd/CNv4_top/xdma_0_ex.runs/synth_1/xilinx_dma_pcie_ep.dcp
  ...
  link_design -top xilinx_dma_pcie_ep -part xcvu9p-flgb2104-2LV-e
...
set rc [catch {
  ...
  read_checkpoint -auto_incremental  -incremental /media/wanner/work/work/fpga_prj/Xmrig-fpga/xmrig_X1_brd/CNv4_top/xdma_0_ex.srcs/utils_1/imports/impl_2/xilinx_dma_pcie_ep_routed.dcp
  catch { report_incremental_reuse -file xilinx_dma_pcie_ep_incremental_reuse_pre_placed.rpt }
...
set rc [catch {
  ...
  write_bitstream -force xilinx_dma_pcie_ep.bit -raw_bitfile
